...
/* Repeat a testcase 2^n times */
#define DEFINE_TEST_BIT_0(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6, _bit5, _bit4, _bit3, _bit2, _bit1) \
    DEFINE_TEST_WITH_TYPE(_name##_##_bit9##_bit8##_bit7##_bit6##_bit5##_bit4##_bit3##_bit2##_bit1, _description, _function, _type, _enabled)

#define DEFINE_TEST_BIT_1(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6, _bit5, _bit4, _bit3, _bit2) \
    DEFINE_TEST_BIT_0(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6, _bit5, _bit4, _bit3, _bit2, 0)  \
    DEFINE_TEST_BIT_0(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6, _bit5, _bit4, _bit3, _bit2, 1)

#define DEFINE_TEST_BIT_2(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6, _bit5, _bit4, _bit3) \
    DEFINE_TEST_BIT_1(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6, _bit5, _bit4, _bit3, 0)  \
    DEFINE_TEST_BIT_1(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6, _bit5, _bit4, _bit3, 1)

#define DEFINE_TEST_BIT_3(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6, _bit5, _bit4) \
    DEFINE_TEST_BIT_2(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6, _bit5, _bit4, 0)  \
    DEFINE_TEST_BIT_2(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6, _bit5, _bit4, 1)

#define DEFINE_TEST_BIT_4(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6, _bit5) \
    DEFINE_TEST_BIT_3(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6, _bit5, 0)  \
    DEFINE_TEST_BIT_3(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6, _bit5, 1)

#define DEFINE_TEST_BIT_5(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6) \
    DEFINE_TEST_BIT_4(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6, 0)  \
    DEFINE_TEST_BIT_4(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, _bit6, 1)

#define DEFINE_TEST_BIT_6(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7) \
    DEFINE_TEST_BIT_5(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, 0)  \
    DEFINE_TEST_BIT_5(_name, _description, _function, _type, _enabled, _bit9, _bit8, _bit7, 1)

#define DEFINE_TEST_BIT_7(_name, _description, _function, _type, _enabled, _bit9, _bit8) \
    DEFINE_TEST_BIT_6(_name, _description, _function, _type, _enabled, _bit9, _bit8, 0)  \
    DEFINE_TEST_BIT_6(_name, _description, _function, _type, _enabled, _bit9, _bit8, 1)

#define DEFINE_TEST_BIT_8(_name, _description, _function, _type, _enabled, _bit9) \
    DEFINE_TEST_BIT_7(_name, _description, _function, _type, _enabled, _bit9, 0)  \
    DEFINE_TEST_BIT_7(_name, _description, _function, _type, _enabled, _bit9, 1)

#define DEFINE_TEST_BIT_9(_name, _description, _function, _type, _enabled) \
    DEFINE_TEST_BIT_8(_name, _description, _function, _type, _enabled, 0)  \
    DEFINE_TEST_BIT_8(_name, _description, _function, _type, _enabled, 1)

#if GPI_BENCHMARK_ITER_BITS == 0
#define DEFINE_TEST_WITH_TYPE_MULTIPLE(_name, _description, _function, _type, _enabled) \
    DEFINE_TEST_BIT_0(_name, _description, _function, _type, _enabled, 0, 0, 0, 0, 0, 0, 0, 0, 0)
#elif GPI_BENCHMARK_ITER_BITS == 1
#define DEFINE_TEST_WITH_TYPE_MULTIPLE(_name, _description, _function, _type, _enabled) \
    DEFINE_TEST_BIT_1(_name, _description, _function, _type, _enabled, 0, 0, 0, 0, 0, 0, 0, 0)
#elif GPI_BENCHMARK_ITER_BITS == 2
#define DEFINE_TEST_WITH_TYPE_MULTIPLE(_name, _description, _function, _type, _enabled) \
    DEFINE_TEST_BIT_2(_name, _description, _function, _type, _enabled, 0, 0, 0, 0, 0, 0, 0)
#elif GPI_BENCHMARK_ITER_BITS == 3
#define DEFINE_TEST_WITH_TYPE_MULTIPLE(_name, _description, _function, _type, _enabled) \
    DEFINE_TEST_BIT_3(_name, _description, _function, _type, _enabled, 0, 0, 0, 0, 0, 0)
#elif GPI_BENCHMARK_ITER_BITS == 4
#define DEFINE_TEST_WITH_TYPE_MULTIPLE(_name, _description, _function, _type, _enabled) \
    DEFINE_TEST_BIT_4(_name, _description, _function, _type, _enabled, 0, 0, 0, 0, 0)
#elif GPI_BENCHMARK_ITER_BITS == 5
#define DEFINE_TEST_WITH_TYPE_MULTIPLE(_name, _description, _function, _type, _enabled) \
    DEFINE_TEST_BIT_5(_name, _description, _function, _type, _enabled, 0, 0, 0, 0)
#elif GPI_BENCHMARK_ITER_BITS == 6
#define DEFINE_TEST_WITH_TYPE_MULTIPLE(_name, _description, _function, _type, _enabled) \
    DEFINE_TEST_BIT_6(_name, _description, _function, _type, _enabled, 0, 0, 0)
#elif GPI_BENCHMARK_ITER_BITS == 7
#define DEFINE_TEST_WITH_TYPE_MULTIPLE(_name, _description, _function, _type, _enabled) \
    DEFINE_TEST_BIT_7(_name, _description, _function, _type, _enabled, 0, 0)
#elif GPI_BENCHMARK_ITER_BITS == 8
#define DEFINE_TEST_WITH_TYPE_MULTIPLE(_name, _description, _function, _type, _enabled) \
    DEFINE_TEST_BIT_8(_name, _description, _function, _type, _enabled, 0)
#else
#define DEFINE_TEST_WITH_TYPE_MULTIPLE(_name, _description, _function, _type, _enabled) \
    DEFINE_TEST_BIT_9(_name, _description, _function, _type, _enabled)
#endif
